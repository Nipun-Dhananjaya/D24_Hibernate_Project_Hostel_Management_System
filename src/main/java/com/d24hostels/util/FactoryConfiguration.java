...
public class FactoryConfiguration {
    ...
    private FactoryConfiguration(){
        ...
        sessionFactory=new Configuration().addAnnotatedClass(Student.class).addAnnotatedClass(Room.class).addAnnotatedClass(Reservation.class).addAnnotatedClass(User.class).mergeProperties(properties).buildSessionFactory();
    }
